...
class ResultPaginator implements \Iterator
{
     ...
     * @param array              $config
     */
    public function __construct(\BWPS\SSU\Aws3\Aws\AwsClientInterface $client, $operation, array $args, array $config)
    {
        $this->client = $client;
    ...
    {
        return \BWPS\SSU\Aws3\GuzzleHttp\Promise\coroutine(function () use($handleResult) {
            $nextToken = null;
            do {
                ...
                if ($retVal !== null) {
                    (yield \BWPS\SSU\Aws3\GuzzleHttp\Promise\promise_for($retVal));
                }
            } while ($nextToken);
        });
    }
    ...
    public function search($expression)
    {
        ...
        return flatmap($this, function (\BWPS\SSU\Aws3\Aws\Result $result) use($expression) {
    ...
    private function determineNextToken(\BWPS\SSU\Aws3\Aws\Result $result)
    {
