...
use BWPS\SSU\Aws3\Aws\AbstractConfigurationProvider;
use BWPS\SSU\Aws3\Aws\CacheInterface;
use BWPS\SSU\Aws3\Aws\ClientSideMonitoring\Exception\ConfigurationException;
use BWPS\SSU\Aws3\Aws\ConfigurationProviderInterface;
 ...
 * </code>
 */
class ConfigurationProvider extends \BWPS\SSU\Aws3\Aws\AbstractConfigurationProvider implements \BWPS\SSU\Aws3\Aws\ConfigurationProviderInterface
{
    ...
    protected static $interfaceClass = \BWPS\SSU\Aws3\Aws\ClientSideMonitoring\ConfigurationInterface::class;
    protected static $exceptionClass = \BWPS\SSU\Aws3\Aws\ClientSideMonitoring\Exception\ConfigurationException::class;
    /**
    ...
    public static function env()
    {
        return function () {
            ...
            if ($enabled !== false) {
                return \BWPS\SSU\Aws3\GuzzleHttp\Promise\promise_for(new \BWPS\SSU\Aws3\Aws\ClientSideMonitoring\Configuration($enabled, getenv(self::ENV_HOST) ?: self::DEFAULT_HOST, getenv(self::ENV_PORT) ?: self::DEFAULT_PORT, getenv(self::ENV_CLIENT_ID) ?: self::DEFAULT_CLIENT_ID));
            }
    ...
    {
        return function () {
            return \BWPS\SSU\Aws3\GuzzleHttp\Promise\promise_for(new \BWPS\SSU\Aws3\Aws\ClientSideMonitoring\Configuration(self::DEFAULT_ENABLED, self::DEFAULT_HOST, self::DEFAULT_PORT, self::DEFAULT_CLIENT_ID));
        };
    }
    /**
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use($profile, $filename) {
            ...
            $data = \BWPS\SSU\Aws3\Aws\parse_ini_file($filename, true);
            if ($data === false) {
            ...
            return \BWPS\SSU\Aws3\GuzzleHttp\Promise\promise_for(new \BWPS\SSU\Aws3\Aws\ClientSideMonitoring\Configuration($data[$profile]['csm_enabled'], $data[$profile]['csm_host'], $data[$profile]['csm_port'], $data[$profile]['csm_client_id']));
        };
    }
    /**
    ...
    public static function unwrap($config)
    {
        ...
        if ($config instanceof ConfigurationInterface) {
            ...
            return new \BWPS\SSU\Aws3\Aws\ClientSideMonitoring\Configuration($config['enabled'], $host, $port, $client_id);
        }
