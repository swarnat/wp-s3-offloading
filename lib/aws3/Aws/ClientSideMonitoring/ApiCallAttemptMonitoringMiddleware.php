 ...
 * @internal
 */
class ApiCallAttemptMonitoringMiddleware extends \BWPS\SSU\Aws3\Aws\ClientSideMonitoring\AbstractMonitoringMiddleware
{
    /**
    ...
    private static function getResultAttemptLatency(\BWPS\SSU\Aws3\Aws\ResultInterface $result)
    {
    ...
    private static function getResultDestinationIp(\BWPS\SSU\Aws3\Aws\ResultInterface $result)
    {
        if (isset($result['@metadata']['transferStats']['http'])) {
            $attempt = end($result['@metadata']['transferStats']['http']);
    ...
    private static function getResultDnsLatency(\BWPS\SSU\Aws3\Aws\ResultInterface $result)
    {
        if (isset($result['@metadata']['transferStats']['http'])) {
            $attempt = end($result['@metadata']['transferStats']['http']);
    ...
    private static function getResultHttpStatusCode(\BWPS\SSU\Aws3\Aws\ResultInterface $result)
    {
        return $result['@metadata']['statusCode'];
    }
    private static function getAwsExceptionAttemptLatency(\BWPS\SSU\Aws3\Aws\Exception\AwsException $e)
    {
    ...
    private static function getAwsExceptionErrorCode(\BWPS\SSU\Aws3\Aws\Exception\AwsException $e)
    {
        return $e->getAwsErrorCode();
    }
    private static function getAwsExceptionMessage(\BWPS\SSU\Aws3\Aws\Exception\AwsException $e)
    {
        return $e->getAwsErrorMessage();
    }
    private static function getAwsExceptionDestinationIp(\BWPS\SSU\Aws3\Aws\Exception\AwsException $e)
    {
        $attempt = $e->getTransferInfo();
        if (isset($attempt['primary_ip'])) {
            return $attempt['primary_ip'];
    ...
    private static function getAwsExceptionDnsLatency(\BWPS\SSU\Aws3\Aws\Exception\AwsException $e)
    {
        $attempt = $e->getTransferInfo();
        if (isset($attempt['namelookup_time'])) {
            return (int) floor($attempt['namelookup_time'] * 1000);
    ...
    private static function getAwsExceptionHttpStatusCode(\BWPS\SSU\Aws3\Aws\Exception\AwsException $e)
    {
