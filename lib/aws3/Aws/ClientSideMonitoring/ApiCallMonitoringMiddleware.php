 ...
 * @internal
 */
class ApiCallMonitoringMiddleware extends \BWPS\SSU\Aws3\Aws\ClientSideMonitoring\AbstractMonitoringMiddleware
{
    /**
    ...
    private static function getResultAttemptCount(\BWPS\SSU\Aws3\Aws\ResultInterface $result)
    {
