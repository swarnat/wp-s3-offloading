...
class RetryMiddleware
{
    ...
    public static function createDefaultDecider($maxRetries = 3, $extraConfig = [])
    {
        ...
        return function ($retries, \BWPS\SSU\Aws3\Aws\CommandInterface $command, \BWPS\SSU\Aws3\Psr\Http\Message\RequestInterface $request, \BWPS\SSU\Aws3\Aws\ResultInterface $result = null, $error = null) use($maxRetries, $retryCurlErrors, $extraConfig) {
