...
use BWPS\SSU\Aws3\JmesPath\Env as JmesPath;
use BWPS\SSU\Aws3\Psr\Http\Message\ResponseInterface;
use BWPS\SSU\Aws3\Psr\Http\Message\RequestInterface;
/**
 * Represents an AWS exception that is thrown when a command fails.
 */
class AwsException extends \RuntimeException implements \BWPS\SSU\Aws3\Aws\MonitoringEventsInterface, \BWPS\SSU\Aws3\Aws\ResponseContainerInterface, \ArrayAccess
{
    use HasDataTrait;
     ...
     */
    public function __construct($message, \BWPS\SSU\Aws3\Aws\CommandInterface $command, array $context = [], \Exception $previous = null)
    {
    ...
    {
        return \BWPS\SSU\Aws3\JmesPath\Env::search($expression, $this->toArray());
    }
}
