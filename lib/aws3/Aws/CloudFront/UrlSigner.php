...
namespace BWPS\SSU\Aws3\Aws\CloudFront;
...
class UrlSigner
{
    ...
    {
        $this->signer = new \BWPS\SSU\Aws3\Aws\CloudFront\Signer($keyPairId, $privateKey);
    }
    /**
    ...
    public function getSignedUrl($url, $expires = null, $policy = null)
    {
        ...
        $uri = new \BWPS\SSU\Aws3\GuzzleHttp\Psr7\Uri($scheme . '://' . $urlSections[1]);
        $query = \BWPS\SSU\Aws3\GuzzleHttp\Psr7\parse_query($uri->getQuery(), PHP_QUERY_RFC3986);
    ...
    private function createRtmpUrl(\BWPS\SSU\Aws3\Psr\Http\Message\UriInterface $uri)
    {
