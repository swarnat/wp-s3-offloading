 ...
 */
class HashingStream implements \BWPS\SSU\Aws3\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\BWPS\SSU\Aws3\Psr\Http\Message\StreamInterface $stream, \BWPS\SSU\Aws3\Aws\HashInterface $hash, callable $onComplete = null)
    {
        $this->stream = $stream;
        $this->hash = $hash;
