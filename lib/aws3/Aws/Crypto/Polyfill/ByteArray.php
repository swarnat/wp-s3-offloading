...
class ByteArray extends \SplFixedArray
{
    ...
    {
        return new \BWPS\SSU\Aws3\Aws\Crypto\Polyfill\ByteArray(\pack('N', $num));
    }
    /**
     * @param ByteArray $other
     * @return bool
     */
    public function equals(\BWPS\SSU\Aws3\Aws\Crypto\Polyfill\ByteArray $other)
    {
     ...
     * @return ByteArray
     */
    public function exclusiveOr(\BWPS\SSU\Aws3\Aws\Crypto\Polyfill\ByteArray $array)
    {
     ...
     * @return ByteArray
     */
    public static function select($select, \BWPS\SSU\Aws3\Aws\Crypto\Polyfill\ByteArray $left, \BWPS\SSU\Aws3\Aws\Crypto\Polyfill\ByteArray $right)
    {
     ...
     * @return self
     */
    public function set(\BWPS\SSU\Aws3\Aws\Crypto\Polyfill\ByteArray $input, $offset = 0, $length = null)
    {
    ...
    {
        return new \BWPS\SSU\Aws3\Aws\Crypto\Polyfill\ByteArray(\array_slice($this->toArray(), $start, $length));
    }
    /**
