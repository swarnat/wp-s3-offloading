 ...
 */
class AesEncryptingStream implements \BWPS\SSU\Aws3\Aws\Crypto\AesStreamInterface
{
    const BLOCK_SIZE = 16;
    // 128 bits
     ...
     */
    public function __construct(\BWPS\SSU\Aws3\Psr\Http\Message\StreamInterface $plainText, $key, \BWPS\SSU\Aws3\Aws\Crypto\Cipher\CipherMethod $cipherMethod)
    {
