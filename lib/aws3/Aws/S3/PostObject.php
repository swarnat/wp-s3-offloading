...
class PostObject
{
     ...
     *                                      behalf.
     */
    public function __construct(\BWPS\SSU\Aws3\Aws\S3\S3ClientInterface $client, $bucket, array $formInputs, $jsonPolicy)
    {
        $this->client = $client;
        $this->bucket = $bucket;
    ...
    protected function getPolicyAndSignature(\BWPS\SSU\Aws3\Aws\Credentials\CredentialsInterface $creds)
    {
