 ...
 * @internal
 */
class AmbiguousSuccessParser extends \BWPS\SSU\Aws3\Aws\Api\Parser\AbstractParser
{
    ...
    public function __construct(callable $parser, callable $errorParser, $exceptionClass = \BWPS\SSU\Aws3\Aws\Exception\AwsException::class)
    {
        $this->parser = $parser;
