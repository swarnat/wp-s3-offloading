...
namespace BWPS\SSU\Aws3\Aws\S3\Exception;
...
class S3MultipartUploadException extends \BWPS\SSU\Aws3\Aws\Exception\MultipartUploadException
{
     ...
     */
    public function __construct(\BWPS\SSU\Aws3\Aws\Multipart\UploadState $state, $prev = null)
    {
     ...
     */
    private function collectPathInfo(\BWPS\SSU\Aws3\Aws\CommandInterface $cmd)
    {
