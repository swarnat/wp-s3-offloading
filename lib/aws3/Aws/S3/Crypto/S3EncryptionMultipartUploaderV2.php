 ...
 */
class S3EncryptionMultipartUploaderV2 extends \BWPS\SSU\Aws3\Aws\S3\MultipartUploader
{
    ...
    private function getEncryptingDataPreparer()
    {
        return function () {
            ...
            list($this->source, $params) = \BWPS\SSU\Aws3\GuzzleHttp\Promise\promise_for($this->encrypt($this->source, $this->config ?: [], $this->provider, $envelope))->then(function ($bodyStream) use($envelope) {
