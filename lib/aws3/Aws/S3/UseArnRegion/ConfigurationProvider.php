...
class ConfigurationProvider extends \BWPS\SSU\Aws3\Aws\AbstractConfigurationProvider implements \BWPS\SSU\Aws3\Aws\ConfigurationProviderInterface
{
    ...
    protected static $interfaceClass = \BWPS\SSU\Aws3\Aws\S3\UseArnRegion\ConfigurationInterface::class;
    protected static $exceptionClass = \BWPS\SSU\Aws3\Aws\S3\UseArnRegion\Exception\ConfigurationException::class;
    /**
    ...
    public static function env()
    {
        return function () {
            ...
            if (!empty($useArnRegion)) {
                return \BWPS\SSU\Aws3\GuzzleHttp\Promise\promise_for(new \BWPS\SSU\Aws3\Aws\S3\UseArnRegion\Configuration($useArnRegion));
            }
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use($profile, $filename) {
            ...
            $data = \BWPS\SSU\Aws3\Aws\parse_ini_file($filename, true, INI_SCANNER_NORMAL);
            if ($data === false) {
            ...
            return \BWPS\SSU\Aws3\GuzzleHttp\Promise\promise_for(new \BWPS\SSU\Aws3\Aws\S3\UseArnRegion\Configuration($data[$profile][self::INI_USE_ARN_REGION]));
        };
    }
    /**
    ...
    {
        return function () {
            return \BWPS\SSU\Aws3\GuzzleHttp\Promise\promise_for(new \BWPS\SSU\Aws3\Aws\S3\UseArnRegion\Configuration(self::DEFAULT_USE_ARN_REGION));
        };
    }
}
