...
use BWPS\SSU\Aws3\Aws\S3\RegionalEndpoint\Exception\ConfigurationException;
...
class ConfigurationProvider extends \BWPS\SSU\Aws3\Aws\AbstractConfigurationProvider implements \BWPS\SSU\Aws3\Aws\ConfigurationProviderInterface
{
    ...
    protected static $interfaceClass = \BWPS\SSU\Aws3\Aws\S3\RegionalEndpoint\ConfigurationInterface::class;
    protected static $exceptionClass = \BWPS\SSU\Aws3\Aws\S3\RegionalEndpoint\Exception\ConfigurationException::class;
    /**
    ...
    public static function env()
    {
        return function () {
            ...
            if (!empty($endpointsType)) {
                return \BWPS\SSU\Aws3\GuzzleHttp\Promise\promise_for(new \BWPS\SSU\Aws3\Aws\S3\RegionalEndpoint\Configuration($endpointsType));
            }
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use($profile, $filename) {
            ...
            return \BWPS\SSU\Aws3\GuzzleHttp\Promise\promise_for(new \BWPS\SSU\Aws3\Aws\S3\RegionalEndpoint\Configuration($data[$profile][self::INI_ENDPOINTS_TYPE]));
        };
    }
    /**
    ...
    {
        return function () {
            return \BWPS\SSU\Aws3\GuzzleHttp\Promise\promise_for(new \BWPS\SSU\Aws3\Aws\S3\RegionalEndpoint\Configuration(self::DEFAULT_ENDPOINTS_TYPE));
        };
    }
    /**
    ...
    public static function unwrap($config)
    {
        ...
        if (is_string($config)) {
            return new \BWPS\SSU\Aws3\Aws\S3\RegionalEndpoint\Configuration($config);
        }
        if (is_array($config) && isset($config['endpoints_type'])) {
            return new \BWPS\SSU\Aws3\Aws\S3\RegionalEndpoint\Configuration($config['endpoints_type']);
        }
