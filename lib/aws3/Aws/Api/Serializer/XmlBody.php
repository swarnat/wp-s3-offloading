...
class XmlBody
{
     ...
     * @return string
     */
    public function build(\BWPS\SSU\Aws3\Aws\Api\Shape $shape, array $args)
    {
        $xml = new \XMLWriter();
        $xml->openMemory();
    ...
    private function startElement(\BWPS\SSU\Aws3\Aws\Api\Shape $shape, $name, \XMLWriter $xml)
    {
    ...
    private function format(\BWPS\SSU\Aws3\Aws\Api\Shape $shape, $name, $value, \XMLWriter $xml)
    {
    ...
    private function defaultShape(\BWPS\SSU\Aws3\Aws\Api\Shape $shape, $name, $value, \XMLWriter $xml)
    {
        $this->startElement($shape, $name, $xml);
        $xml->text($value);
        $xml->endElement();
    }
    private function add_structure(\BWPS\SSU\Aws3\Aws\Api\StructureShape $shape, $name, array $value, \XMLWriter $xml)
    {
        $this->startElement($shape, $name, $xml);
    ...
    private function getStructureMembers(\BWPS\SSU\Aws3\Aws\Api\StructureShape $shape, array $value)
    {
        $members = [];
    ...
    private function add_list(\BWPS\SSU\Aws3\Aws\Api\ListShape $shape, $name, array $value, \XMLWriter $xml)
    {
    ...
    private function add_map(\BWPS\SSU\Aws3\Aws\Api\MapShape $shape, $name, array $value, \XMLWriter $xml)
    {
    ...
    private function add_blob(\BWPS\SSU\Aws3\Aws\Api\Shape $shape, $name, $value, \XMLWriter $xml)
    {
        $this->startElement($shape, $name, $xml);
        $xml->writeRaw(base64_encode($value));
        $xml->endElement();
    }
    private function add_timestamp(\BWPS\SSU\Aws3\Aws\Api\TimestampShape $shape, $name, $value, \XMLWriter $xml)
    {
        $this->startElement($shape, $name, $xml);
        $timestampFormat = !empty($shape['timestampFormat']) ? $shape['timestampFormat'] : 'iso8601';
        $xml->writeRaw(\BWPS\SSU\Aws3\Aws\Api\TimestampShape::format($value, $timestampFormat));
        $xml->endElement();
    }
    private function add_boolean(\BWPS\SSU\Aws3\Aws\Api\Shape $shape, $name, $value, \XMLWriter $xml)
    {
        $this->startElement($shape, $name, $xml);
        $xml->writeRaw($value ? 'true' : 'false');
        $xml->endElement();
    }
    private function add_string(\BWPS\SSU\Aws3\Aws\Api\Shape $shape, $name, $value, \XMLWriter $xml)
    {
