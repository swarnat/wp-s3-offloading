 ...
 * @internal
 */
class RestJsonSerializer extends \BWPS\SSU\Aws3\Aws\Api\Serializer\RestSerializer
{
    /** @var JsonBody */
    ...
    public function __construct(\BWPS\SSU\Aws3\Aws\Api\Service $api, $endpoint, \BWPS\SSU\Aws3\Aws\Api\Serializer\JsonBody $jsonFormatter = null)
    {
        ...
        $this->jsonFormatter = $jsonFormatter ?: new \BWPS\SSU\Aws3\Aws\Api\Serializer\JsonBody($api);
    }
