...
use BWPS\SSU\Aws3\Aws\Api\Serializer\QuerySerializer;
use BWPS\SSU\Aws3\Aws\Api\Serializer\Ec2ParamBuilder;
use BWPS\SSU\Aws3\Aws\Api\Parser\QueryParser;
/**
 * Represents a web service API model.
 */
class Service extends \BWPS\SSU\Aws3\Aws\Api\AbstractModel
{
    /** @var callable */
    private $apiProvider;
    /** @var string */
    ...
    public function __construct(array $definition, callable $provider)
    {
        ...
        parent::__construct($definition, new \BWPS\SSU\Aws3\Aws\Api\ShapeMap($definition['shapes']));
     ...
     */
    public static function createSerializer(\BWPS\SSU\Aws3\Aws\Api\Service $api, $endpoint)
    {
        static $mapping = ['json' => 'BWPS\\SSU\\Aws3\\Aws\\Api\\Serializer\\JsonRpcSerializer', 'query' => 'BWPS\\SSU\\Aws3\\Aws\\Api\\Serializer\\QuerySerializer', 'rest-json' => 'BWPS\\SSU\\Aws3\\Aws\\Api\\Serializer\\RestJsonSerializer', 'rest-xml' => 'BWPS\\SSU\\Aws3\\Aws\\Api\\Serializer\\RestXmlSerializer'];
        $proto = $api->getProtocol();
        if (isset($mapping[$proto])) {
            return new $mapping[$proto]($api, $endpoint);
        }
        if ($proto == 'ec2') {
            return new \BWPS\SSU\Aws3\Aws\Api\Serializer\QuerySerializer($api, $endpoint, new \BWPS\SSU\Aws3\Aws\Api\Serializer\Ec2ParamBuilder());
        }
     ...
     * @throws \UnexpectedValueException
     */
    public static function createErrorParser($protocol, \BWPS\SSU\Aws3\Aws\Api\Service $api = null)
    {
        static $mapping = ['json' => 'BWPS\\SSU\\Aws3\\Aws\\Api\\ErrorParser\\JsonRpcErrorParser', 'query' => 'BWPS\\SSU\\Aws3\\Aws\\Api\\ErrorParser\\XmlErrorParser', 'rest-json' => 'BWPS\\SSU\\Aws3\\Aws\\Api\\ErrorParser\\RestJsonErrorParser', 'rest-xml' => 'BWPS\\SSU\\Aws3\\Aws\\Api\\ErrorParser\\XmlErrorParser', 'ec2' => 'BWPS\\SSU\\Aws3\\Aws\\Api\\ErrorParser\\XmlErrorParser'];
     ...
     * @throws \UnexpectedValueException
     */
    public static function createParser(\BWPS\SSU\Aws3\Aws\Api\Service $api)
    {
        static $mapping = ['json' => 'BWPS\\SSU\\Aws3\\Aws\\Api\\Parser\\JsonRpcParser', 'query' => 'BWPS\\SSU\\Aws3\\Aws\\Api\\Parser\\QueryParser', 'rest-json' => 'BWPS\\SSU\\Aws3\\Aws\\Api\\Parser\\RestJsonParser', 'rest-xml' => 'BWPS\\SSU\\Aws3\\Aws\\Api\\Parser\\RestXmlParser'];
        $proto = $api->getProtocol();
        if (isset($mapping[$proto])) {
            return new $mapping[$proto]($api);
        }
        if ($proto == 'ec2') {
            return new \BWPS\SSU\Aws3\Aws\Api\Parser\QueryParser($api, null, false);
        }
        throw new \UnexpectedValueException('Unknown protocol: ' . $api->getProtocol());
    }
    /**
    ...
    public function getOperation($name)
    {
        if (!isset($this->operations[$name])) {
            ...
            $this->operations[$name] = new \BWPS\SSU\Aws3\Aws\Api\Operation($this->definition['operations'][$name], $this->shapeMap);
        }
    ...
    public function getErrorShapes()
    {
        ...
        foreach ($this->definition['shapes'] as $name => $definition) {
            if (!empty($definition['exception'])) {
                ...
                $result[] = new \BWPS\SSU\Aws3\Aws\Api\StructureShape($definition, $this->getShapeMap());
            }
        }
        return $result;
    }
