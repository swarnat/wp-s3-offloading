 ...
 */
class QueryParser extends \BWPS\SSU\Aws3\Aws\Api\Parser\AbstractParser
{
     ...
     *                                      output structure.
     */
    public function __construct(\BWPS\SSU\Aws3\Aws\Api\Service $api, \BWPS\SSU\Aws3\Aws\Api\Parser\XmlParser $xmlParser = null, $honorResultWrapper = true)
    {
        parent::__construct($api);
        $this->parser = $xmlParser ?: new \BWPS\SSU\Aws3\Aws\Api\Parser\XmlParser();
    ...
    public function __invoke(\BWPS\SSU\Aws3\Aws\CommandInterface $command, \BWPS\SSU\Aws3\Psr\Http\Message\ResponseInterface $response)
    {
        ...
        return new \BWPS\SSU\Aws3\Aws\Result($this->parser->parse($output, $xml));
    }
