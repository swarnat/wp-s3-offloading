...
use BWPS\SSU\Aws3\Aws\Api\Parser\XmlParser;
 ...
 * Parses XML errors.
 */
class XmlErrorParser extends \BWPS\SSU\Aws3\Aws\Api\ErrorParser\AbstractErrorParser
{
    use PayloadParserTrait;
    protected $parser;
    public function __construct(\BWPS\SSU\Aws3\Aws\Api\Service $api = null, \BWPS\SSU\Aws3\Aws\Api\Parser\XmlParser $parser = null)
    {
    ...
    private function parseHeaders(\BWPS\SSU\Aws3\Psr\Http\Message\ResponseInterface $response, array &$data)
    {
