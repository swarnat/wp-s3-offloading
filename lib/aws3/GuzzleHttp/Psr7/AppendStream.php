 ...
 * @final
 */
class AppendStream implements \BWPS\SSU\Aws3\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\BWPS\SSU\Aws3\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \BWPS\SSU\Aws3\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
