 ...
 * @final
 */
class FnStream implements \BWPS\SSU\Aws3\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\BWPS\SSU\Aws3\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
