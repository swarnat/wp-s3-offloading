...
class StreamWrapper
{
     ...
     */
    public static function getResource(\BWPS\SSU\Aws3\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\BWPS\SSU\Aws3\Psr\Http\Message\StreamInterface $stream)
    {
