 ...
 * @final
 */
class LimitStream implements \BWPS\SSU\Aws3\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\BWPS\SSU\Aws3\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
