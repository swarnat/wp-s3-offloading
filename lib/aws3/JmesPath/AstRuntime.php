...
class AstRuntime
{
    ...
    public function __construct(\BWPS\SSU\Aws3\JmesPath\Parser $parser = null, callable $fnDispatcher = null)
    {
        $fnDispatcher = $fnDispatcher ?: \BWPS\SSU\Aws3\JmesPath\FnDispatcher::getInstance();
        $this->interpreter = new \BWPS\SSU\Aws3\JmesPath\TreeInterpreter($fnDispatcher);
        $this->parser = $parser ?: new \BWPS\SSU\Aws3\JmesPath\Parser();
    }
    /**
