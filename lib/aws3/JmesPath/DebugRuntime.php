...
class DebugRuntime
{
    ...
    public function __construct(callable $runtime, $output = null)
    {
        ...
        $this->lexer = new \BWPS\SSU\Aws3\JmesPath\Lexer();
        $this->parser = new \BWPS\SSU\Aws3\JmesPath\Parser($this->lexer);
    }
    ...
    {
        $lexer = new \BWPS\SSU\Aws3\JmesPath\Lexer();
    ...
    {
        $parser = new \BWPS\SSU\Aws3\JmesPath\Parser();
